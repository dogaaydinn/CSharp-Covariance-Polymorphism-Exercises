using ConsoleApp2.Beginner.Override;
...
public class Car : Vehicle
{
    ...
    public static void CastExample()
    {
        ...
        if (myVehicle is Car myNewCar)
        {
            ...
            myNewCar.DisplayCarInfo(); // Güvenli bir şekilde Car nesnesine ait metod çağrılır
        }
        else
        {
        ...
        try
        {
            ...
            myExplicitCar.DisplayCarInfo(); // Güvenli metod çağrısı
        }
